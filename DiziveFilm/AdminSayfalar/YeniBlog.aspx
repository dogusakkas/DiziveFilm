<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="YeniBlog.aspx.cs" Inherits="DiziveFilm.AdminSayfalar.YeniBlog" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server" class="form-group">
        ...
        <br />
        <asp:Button ID="Btn_Kaydet" runat="server" Text="Kaydet" CssClass="btn btn-success" OnClick="Btn_Kaydet_Click" />
